...
export default class AskQiitaView
{
    ...
    showLoadingSpinner()
    {
        ...
        loadingSpinner.setAttribute("style", "display:flex; justify-content:center; padding:10px");
        loadingSpinner.innerHTML = "<span class='loading loading-spinner-medium'></span";
